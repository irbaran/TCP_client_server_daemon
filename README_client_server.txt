TCP client server with daemon producers.
...
Independent daemon services consults server resources each 5 seconds 
and store information in files. The writing and reading synchronism are
done by file locking.  
...
- daemon_server_infomemd.h
- server_infomemd.exe
- daemon_server_processtop10d.cpp
- daemon_server_processtop10d.h
- server_processtop10d.exe
- Makefile
- README_client_server.txt
...
g++ -o server_processtop10d.exe daemon_server_processtop10d.cpp
g++ -o server_infomemd.exe daemon_server_infomemd.cpp
